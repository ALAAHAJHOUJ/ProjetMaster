  ...
  return (
        <header className='min-w-[325px] w-[92%] max-w-[1440px] mx-auto relative'>
              ...
              <div className='bg-[#0b0b0bb1] w-full h-full absolute right-0 top-0 flex flex-col justify-center items-center'>
                    <h1 className='text-[#FFD15B] leading-normal inline-block max-w-[50%] text-[clamp(1rem,4vw,44px)] text-center mb-2'>DECOUVEREZ NOS TENDANCES QUI FLAMBENT A TRAVERS NOS MEILLEURES RECETTES</h1>
